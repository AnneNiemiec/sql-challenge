...
select d.dept_name=sales, e.emp_no, e.last_name, e.first_name, d.dept_name
from departments_csv as d
inner join dept_emp as de
	on d.dept_no = de.dept_no;
...
select d.dept_name=('Sales', 'Development'), e.emp_no, e.last_name, e.first_name, d.dept_name
from departments_csv as d
inner join dept_emp as de
	on d.dept_no = de.dept_no;
